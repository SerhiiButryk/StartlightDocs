---
title: Welcome to Tankard 🍺 Docs!
description: Welcome to Tankard 🍺 Docs!
template: splash # Remove or comment out this line to display the site sidebar on this page.
hero:
  tagline: Be a better developer and remember R.I.B. — rest in beer! 🍺🍺🍺
  image:
    file: ../../assets/logo.png
  actions:
    - text: Go to Tankard 🍺 Docs
      link: guides/dev_links
      icon: right-arrow
---
